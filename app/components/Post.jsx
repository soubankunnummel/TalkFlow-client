...
const Post = () => {
  ...
  return (
    <>
      <div className="w-full md:w-[580px] h-full  md:p-2 p-3 flex flex-col  justify-between items-center mb-28">
        ...
        <div className="h-full w-[1px] bg-white bg-opacity-30 rounded-lg"></div>
              </div>
            </div>
          ...
          <div className="h-auto w-full bg-black border-t-[2px] border-white flex border-opacity-30 p-2">
            <div className="h-full w-fit">
              <div className="w-fit h-full  flex flex-col items-center gap-3">
              <div
            className="h-10 w-10 rounded-full bg-white box-border "
          ...
          >
            ...
            <div className="h-[100px] w-[1px] bg-white bg-opacity-30 rounded-lg"></div>
              </div>
            </div>
              <div className="w-full h-full bg-black flex flex-col">
                <div className="w-full flex m-3 justify-between gap-3 items-center">
                ...
                <div className="h-[800px] w-full bg-white m-2"></div>
                 </div>
