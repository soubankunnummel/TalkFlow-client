    ...
    <>
       <div className="w-full md:w-[580px] h-full  md:p-2 p-3 flex flex-col  justify-between items-center mb-10 ">
          ...
          <div className="h-auto w-full flex justify-between   p-2">
            ...
            <span >usename </span>
            <button className="bg-stone-900 w-[100px] rounded-xl text-white text-opacity-20 ">threas.net</button>
            </div>

              <div className="flex justify-stretch ">
                <div className="w-4 h-4 rounded-full bg-white mt-5"
                style={{
                  backgroundImage:
                ...
                <span className="mt-4 text-white text-opacity-20 ms-5"> 133 follower</span>
            ...
            <div className="h-16 w-16 rounded-full bg-white box-border md:h-20 md:w-20"
            style={{
              backgroundImage:
                "url('https://img.freepik.com/free-photo/people-holding-wechat-icon_53876-63371.jpg?size=626&ext=jpg&ga=GA1.1.1677573732.1702106196&semt=ais')",
              backgroundSize: "contain",
            ...
            <div  className="text-2xl ml-12 mt-5"><FaInstagram/> </div>
              </div>
          ...
          <button className="w-full h-9 bg-transparent border border-solid text-center rounded-md mt-3">follow</button>
